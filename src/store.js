...
export const store = createStore({
    ...
    getters: {
        ...
        getDMWonders: (state) => {
            ...
            var dm = 0
            if (state.data['wonderPrecious1'] > 0 && state.data['wonderEnergetic1'] > 0 && state.data['wonderTechnological1'] > 0 && state.data['wonderMeteorite1'] > 0) dm += 4
            if (state.data['wonderComm'] > 0 && state.data['wonderSpaceship'] > 0 && state.data['wonderAntimatter'] > 0 && state.data['wonderPortal'] > 0) dm += 4
            if (state.data['wonderStargate'] > 0) dm += 2
            return dm
        },
        /*--------------------------------------------------------------------*/
        getDMSpheres: (state) => {
        ...
        getDMResearches: (state) => {
            ...
            return Math.floor((state.data['boostProduction1'].count + state.data['boostEnergy'].count + state.data['boostScience'].count + state.data['boostEnergyStorage'].count) / 25) * 2
        },
        /*--------------------------------------------------------------------*/
        getDMRank: (state) => {
        ...
        getStarSpeed: (state) => (id) => {
            ...
            var val = (star.stats.defense).toString()
            var unknown = ''
            for (var i = 0; i < val.length - (star.spy - 1); i++) { unknown += '?' }
            return val.substring(0, star.spy - 1) + unknown
        },
    ...
    actions: {
        ...
        initialize({ state }) {
            ...
            /*----------------------------------------------------------------*/
            state.data['scienceT1'] = { id:'scienceT1', unlocked:false, count:0, active:0, costType:'EXPONENTIAL', baseCosts:[{ id:'metal', count:20       }, { id:'gem', count:15      }, { id:'wood', count:10       }], outputs:[{ id:'science', count:0.1  }], notifs:['sciencePane'], }
            state.data['scienceT2'] = { id:'scienceT2', unlocked:false, count:0, active:0, costType:'EXPONENTIAL', baseCosts:[{ id:'metal', count:1000     }, { id:'gem', count:200     }, { id:'wood', count:500      }], outputs:[{ id:'science', count:1    }], notifs:['sciencePane'], }
            state.data['scienceT3'] = { id:'scienceT3', unlocked:false, count:0, active:0, costType:'EXPONENTIAL', baseCosts:[{ id:'metal', count:17000    }, { id:'gem', count:4700    }, { id:'wood', count:9600     }], outputs:[{ id:'science', count:10   }], notifs:['sciencePane'], }
            state.data['scienceT4'] = { id:'scienceT4', unlocked:false, count:0, active:0, costType:'EXPONENTIAL', baseCosts:[{ id:'metal', count:610000   }, { id:'gem', count:370000  }, { id:'wood', count:926000   }], outputs:[{ id:'science', count:100  }], notifs:['sciencePane'], }
            state.data['scienceT5'] = { id:'scienceT5', unlocked:false, count:0, active:0, costType:'EXPONENTIAL', baseCosts:[{ id:'metal', count:12400000 }, { id:'gem', count:7300000 }, { id:'wood', count:15900000 }], outputs:[{ id:'science', count:1000 }], notifs:['sciencePane'], }
            /*----------------------------------------------------------------*/
            ...
            /*----------------------------------------------------------------*/
            state.data['fuelT1'] = { id:'fuelT1', unlocked:false, count:0, active:0, costType:'EXPONENTIAL', baseCosts:[{ id:'metal',    count:1000   }, { id:'gem',     count:750   }, { id:'wood', count:500   }], outputs:[{ id:'fuel', count:0.2 }], inputs:[{ id:'carbon',  count:20  }, { id:'oil', count:20  }], notifs:['fuelPane'], }
            state.data['fuelT2'] = { id:'fuelT2', unlocked:false, count:0, active:0, costType:'EXPONENTIAL', baseCosts:[{ id:'metal',    count:12000  }, { id:'gem',     count:8300  }, { id:'wood', count:6800  }], outputs:[{ id:'fuel', count:1.5 }], inputs:[{ id:'carbon',  count:100 }, { id:'oil', count:100 }], notifs:['fuelPane'], }
            state.data['fuelT3'] = { id:'fuelT3', unlocked:false, count:0, active:0, costType:'EXPONENTIAL', baseCosts:[{ id:'titanium', count:140000 }, { id:'silicon', count:96300 }, { id:'gold', count:78600 }], outputs:[{ id:'fuel', count:20  }], inputs:[{ id:'methane', count:520 }],                          notifs:['fuelPane'], }
            /*----------------------------------------------------------------*/
            ...
            // FLOOR #3
            /*----------------------------------------------------------------*/
            state.data['wonderStargate'] = { id:'wonderStargate',unlocked:false, count:0,max:1, costType:'FIXED', baseCosts:[{ id:'plasma', count:500000 }, { id:'silicon', count:920000000 }, { id:'meteorite', count:17000000 }], notifs:['floor3Pane'], unlocks:['fleet', 'shipT1', 'shipT2', 'shipT3', 'shipT4', 'shipT5'], }
            /*----------------------------------------------------------------*/
            ...
            // DYSON
            /*----------------------------------------------------------------*/
            state.data['segment'] = { id:'segment', unlocked:false, count:0,                  costType:'EXPONENTIAL', baseCosts:[{ id:'titanium', count:300000 }, { id:'gold', count:100000 }, { id:'silicon', count:200000 }, { id:'meteorite', count:1000 }, { id:'ice', count:100000 }], notifs:['dysonPane'], }
            ...
            state.data['dysonT3'] = { id:'dysonT3', unlocked:false, count:0, active:0, max:1, costType:'FIXED',       baseCosts:[{ id:'segment',  count:250    }, { id:'fuel', count:1000000 }], outputs:[{ id:'energy', count:1000000 }],                                                  notifs:['dysonPane'], }            
            /*----------------------------------------------------------------*/
            ...
            /*----------------------------------------------------------------*/
            state.data['antimatterT1'] = { id:'antimatterT1', unlocked:false, count:0, active:0, costType:'EXPONENTIAL', baseCosts:[{ id:'silver', count:163000000 }, { id:'oil', count:712000000 }, { id:'meteorite', count:12300000 }], outputs:[{ id:'antimatter', count:0.5 }], inputs:[{ id:'plasma', count:100 }, { id:'ice', count:12000 }], notifs:['antimatterPane'], }
            /*----------------------------------------------------------------*/
            ...
            // SPACESHIP
            /*----------------------------------------------------------------*/
            state.data['spaceship'] = { id:'spaceship', unlocked:false, count:0, max:1,  costType:'FIXED',       baseCosts:[{ id:'shield',   count:50       }, { id:'engine',    count:25       }, { id:'aero',     count:15       }], notifs:['spaceshipPane'], }
            ...
            // CARNELIAN STARS
            /*----------------------------------------------------------------*/
            state.data['star301'] =    { id:'star301',    unlocked:false, status:'new', spy:0, distance:5.94,  planets:0, faction:'carnelian', resource1:'hydrogen',  resource2:'helium',    stats:{ 'power':52,   'defense':49,   'speed':6  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:59400  }], notifs:['interstellarCarnelianPane'], }
            state.data['star163901'] = { id:'star163901', unlocked:false, status:'new', spy:0, distance:10.33, planets:2, faction:'carnelian', resource1:'uranium',   resource2:'methane',   stats:{ 'power':273,  'defense':226,  'speed':15 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:103300 }], notifs:['interstellarCarnelianPane'], }
            state.data['star181901'] = { id:'star181901', unlocked:false, status:'new', spy:0, distance:11.41, planets:1, faction:'carnelian', resource1:'gem',       resource2:'carbon',    stats:{ 'power':397,  'defense':381,  'speed':5  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:114100 }], notifs:['interstellarCarnelianPane'], }
            state.data['star151801'] = { id:'star151801', unlocked:false, status:'new', spy:0, distance:11.83, planets:5, faction:'carnelian', resource1:'gem',       resource2:'oil',       stats:{ 'power':317,  'defense':202,  'speed':8  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:118300 }], notifs:['interstellarCarnelianPane'], }
            state.data['star25401'] =  { id:'star25401',  unlocked:false, status:'new', spy:0, distance:11.94, planets:4, faction:'carnelian', resource1:'uranium',   resource2:'gem',       stats:{ 'power':207,  'defense':372,  'speed':11 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:119400 }], notifs:['interstellarCarnelianPane'], }
            state.data['star146301'] = { id:'star146301', unlocked:false, status:'new', spy:0, distance:12.87, planets:5, faction:'carnelian', resource1:'meteorite', resource2:'silver',    stats:{ 'power':311,  'defense':466,  'speed':6  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:128700 }], notifs:['interstellarCarnelianPane'], }
            state.data['star122601'] = { id:'star122601', unlocked:false, status:'new', spy:0, distance:14.77, planets:2, faction:'carnelian', resource1:'lunarite',  resource2:'lunarite',  stats:{ 'power':426,  'defense':317,  'speed':12 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:147700 }], notifs:['interstellarCarnelianPane'], }
            state.data['star79501'] =  { id:'star79501',  unlocked:false, status:'new', spy:0, distance:15.07, planets:1, faction:'carnelian', resource1:'lunarite',  resource2:'silver',    stats:{ 'power':675,  'defense':565,  'speed':8  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:150700 }], notifs:['interstellarCarnelianPane'], }
            state.data['star1501'] =   { id:'star1501',   unlocked:false, status:'new', spy:0, distance:15.33, planets:1, faction:'carnelian', resource1:'gold',      resource2:'gold',      stats:{ 'power':410,  'defense':321,  'speed':6  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:153300 }], notifs:['interstellarCarnelianPane'], }
            state.data['star79901'] =  { id:'star79901',  unlocked:false, status:'new', spy:0, distance:17.58, planets:1, faction:'carnelian', resource1:'carbon',    resource2:'gold',      stats:{ 'power':956,  'defense':615,  'speed':6  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:175800 }], notifs:['interstellarCarnelianPane'], }
            state.data['star37601'] =  { id:'star37601',  unlocked:false, status:'new', spy:0, distance:18.56, planets:1, faction:'carnelian', resource1:'ice',       resource2:'meteorite', stats:{ 'power':706,  'defense':729,  'speed':14 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:185600 }], notifs:['interstellarCarnelianPane'], }
            state.data['star123401'] = { id:'star123401', unlocked:false, status:'new', spy:0, distance:18.95, planets:5, faction:'carnelian', resource1:'carbon',    resource2:'silicon',   stats:{ 'power':1415, 'defense':525,  'speed':13 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:189500 }], notifs:['interstellarCarnelianPane'], }
            state.data['star164301'] = { id:'star164301', unlocked:false, status:'new', spy:0, distance:19.47, planets:1, faction:'carnelian', resource1:'gem',       resource2:'silver',    stats:{ 'power':497,  'defense':424,  'speed':7  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:194700 }], notifs:['interstellarCarnelianPane'], }
            state.data['star219102'] = { id:'star219102', unlocked:false, status:'new', spy:0, distance:20.38, planets:1, faction:'carnelian', resource1:'wood',      resource2:'meteorite', stats:{ 'power':1232, 'defense':921,  'speed':11 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:203800 }], notifs:['interstellarCarnelianPane'], }
            state.data['star204702'] = { id:'star204702', unlocked:false, status:'new', spy:0, distance:20.62, planets:1, faction:'carnelian', resource1:'ice',       resource2:'helium',    stats:{ 'power':550,  'defense':863,  'speed':15 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:206200 }], notifs:['interstellarCarnelianPane'], }
            state.data['star116901'] = { id:'star116901', unlocked:false, status:'new', spy:0, distance:21.18, planets:1, faction:'carnelian', resource1:'oil',       resource2:'lunarite',  stats:{ 'power':1570, 'defense':577,  'speed':10 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:211800 }], notifs:['interstellarCarnelianPane'], }
            state.data['star74001'] =  { id:'star74001',  unlocked:false, status:'new', spy:0, distance:21.61, planets:4, faction:'carnelian', resource1:'hydrogen',  resource2:'titanium',  stats:{ 'power':1494, 'defense':1183, 'speed':7  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:216100 }], notifs:['interstellarCarnelianPane'], }
            state.data['star205102'] = { id:'star205102', unlocked:false, status:'new', spy:0, distance:22.74, planets:5, faction:'carnelian', resource1:'silicon',   resource2:'silver',    stats:{ 'power':1190, 'defense':810,  'speed':9  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:227400 }], notifs:['interstellarCarnelianPane'], }
            state.data['star144001'] = { id:'star144001', unlocked:false, status:'new', spy:0, distance:22.98, planets:1, faction:'carnelian', resource1:'helium',    resource2:'methane',   stats:{ 'power':1488, 'defense':1031, 'speed':12 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:229800 }], notifs:['interstellarCarnelianPane'], }
            state.data['star222301'] = { id:'star222301', unlocked:false, status:'new', spy:0, distance:24.32, planets:5, faction:'carnelian', resource1:'hydrogen',  resource2:'uranium',   stats:{ 'power':2311, 'defense':1758, 'speed':8  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:243200 }], notifs:['interstellarCarnelianPane'], }
            state.data['star3901'] =   { id:'star3901',   unlocked:false, status:'new', spy:0, distance:24.56, planets:3, faction:'carnelian', resource1:'lava',      resource2:'uranium',   stats:{ 'power':1181, 'defense':671,  'speed':9  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:245600 }], notifs:['interstellarCarnelianPane'], }
            state.data['star168301'] = { id:'star168301', unlocked:false, status:'new', spy:0, distance:24.63, planets:1, faction:'carnelian', resource1:'lunarite',  resource2:'lunarite',  stats:{ 'power':1253, 'defense':1759, 'speed':14 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:246300 }], notifs:['interstellarCarnelianPane'], }
            state.data['star120901'] = { id:'star120901', unlocked:false, status:'new', spy:0, distance:25.18, planets:5, faction:'carnelian', resource1:'lava',      resource2:'meteorite', stats:{ 'power':900,  'defense':988,  'speed':11 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:251800 }], notifs:['interstellarCarnelianPane'], }
            state.data['star125301'] = { id:'star125301', unlocked:false, status:'new', spy:0, distance:25.43, planets:1, faction:'carnelian', resource1:'metal',     resource2:'ice',       stats:{ 'power':2583, 'defense':1775, 'speed':11 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:254300 }], notifs:['interstellarCarnelianPane'], }
            state.data['star113101'] = { id:'star113101', unlocked:false, status:'new', spy:0, distance:26.23, planets:3, faction:'carnelian', resource1:'gold',      resource2:'methane',   stats:{ 'power':2375, 'defense':1583, 'speed':9  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:262300 }], notifs:['interstellarCarnelianPane'], }
            state.data['star89101'] =  { id:'star89101',  unlocked:false, status:'new', spy:0, distance:26.56, planets:5, faction:'carnelian', resource1:'titanium',  resource2:'oil',       stats:{ 'power':1939, 'defense':1945, 'speed':14 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:265600 }], notifs:['interstellarCarnelianPane'], }
            state.data['star93901'] =  { id:'star93901',  unlocked:false, status:'new', spy:0, distance:26.69, planets:1, faction:'carnelian', resource1:'oil',       resource2:'ice',       stats:{ 'power':1426, 'defense':1905, 'speed':14 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:266900 }], notifs:['interstellarCarnelianPane'], }
            state.data['star79201'] =  { id:'star79201',  unlocked:false, status:'new', spy:0, distance:27.41, planets:5, faction:'carnelian', resource1:'silver',    resource2:'silver',    stats:{ 'power':946,  'defense':1465, 'speed':15 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:274100 }], notifs:['interstellarCarnelianPane'], }
            state.data['star80501'] =  { id:'star80501',  unlocked:false, status:'new', spy:0, distance:27.9,  planets:2, faction:'carnelian', resource1:'wood',      resource2:'metal',     stats:{ 'power':897,  'defense':2072, 'speed':13 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:279000 }], notifs:['interstellarCarnelianPane'], }
            state.data['star77301'] =  { id:'star77301',  unlocked:false, status:'new', spy:0, distance:28.61, planets:1, faction:'carnelian', resource1:'lunarite',  resource2:'carbon',    stats:{ 'power':1216, 'defense':2159, 'speed':11 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:286100 }], notifs:['interstellarCarnelianPane'], }
            state.data['star191701'] = { id:'star191701', unlocked:false, status:'new', spy:0, distance:30.14, planets:1, faction:'carnelian', resource1:'gem',       resource2:'carbon',    stats:{ 'power':2828, 'defense':1442, 'speed':5  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:301400 }], notifs:['interstellarCarnelianPane'], }
            state.data['star199702'] = { id:'star199702', unlocked:false, status:'new', spy:0, distance:33.34, planets:1, faction:'carnelian', resource1:'methane',   resource2:'silver',    stats:{ 'power':4019, 'defense':1982, 'speed':12 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:333400 }], notifs:['interstellarCarnelianPane'], }
            state.data['star21001'] =  { id:'star21001',  unlocked:false, status:'new', spy:0, distance:33.63, planets:4, faction:'carnelian', resource1:'methane',   resource2:'meteorite', stats:{ 'power':2811, 'defense':1846, 'speed':7  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:336300 }], notifs:['interstellarCarnelianPane'], }
            state.data['star178302'] = { id:'star178302', unlocked:false, status:'new', spy:0, distance:33.73, planets:1, faction:'carnelian', resource1:'methane',   resource2:'methane',   stats:{ 'power':3481, 'defense':1638, 'speed':13 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:337300 }], notifs:['interstellarCarnelianPane'], }
            state.data['star32201'] =  { id:'star32201',  unlocked:false, status:'new', spy:0, distance:34.7,  planets:1, faction:'carnelian', resource1:'silver',    resource2:'silver',    stats:{ 'power':4755, 'defense':2729, 'speed':15 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:347000 }], notifs:['interstellarCarnelianPane'], }
            state.data['star74801'] =  { id:'star74801',  unlocked:false, status:'new', spy:0, distance:34.86, planets:2, faction:'carnelian', resource1:'gem',       resource2:'helium',    stats:{ 'power':2973, 'defense':1585, 'speed':9  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:348600 }], notifs:['interstellarCarnelianPane'], }
            /*----------------------------------------------------------------*/

            // PRASNIAN STARS
            /*----------------------------------------------------------------*/
            state.data['star401'] =    { id:'star401',    unlocked:false, status:'new', spy:0, distance:7.8,   planets:1, faction:'prasnian', resource1:'lunarite', resource2:'gem',       stats:{ 'power':86,   'defense':71,   'speed':8  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:78000  }], notifs:['interstellarPrasnianPane'], }
            state.data['star25101'] =  { id:'star25101',  unlocked:false, status:'new', spy:0, distance:10.5,  planets:5, faction:'prasnian', resource1:'hydrogen', resource2:'metal',     stats:{ 'power':293,  'defense':112,  'speed':13 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:105000 }], notifs:['interstellarPrasnianPane'], }
            state.data['star207601'] = { id:'star207601', unlocked:false, status:'new', spy:0, distance:11.64, planets:1, faction:'prasnian', resource1:'helium',   resource2:'lunarite',  stats:{ 'power':203,  'defense':238,  'speed':7  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:116400 }], notifs:['interstellarPrasnianPane'], }
            state.data['star223901'] = { id:'star223901', unlocked:false, status:'new', spy:0, distance:12.4,  planets:4, faction:'prasnian', resource1:'silver',   resource2:'meteorite', stats:{ 'power':530,  'defense':337,  'speed':14 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:124000 }], notifs:['interstellarPrasnianPane'], }
            state.data['star121101'] = { id:'star121101', unlocked:false, status:'new', spy:0, distance:14.8,  planets:1, faction:'prasnian', resource1:'methane',  resource2:'hydrogen',  stats:{ 'power':750,  'defense':567,  'speed':14 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:148000 }], notifs:['interstellarPrasnianPane'], }
            state.data['star136701'] = { id:'star136701', unlocked:false, status:'new', spy:0, distance:16.77, planets:1, faction:'prasnian', resource1:'methane',  resource2:'metal',     stats:{ 'power':559,  'defense':388,  'speed':6  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:167700 }], notifs:['interstellarPrasnianPane'], }
            state.data['star166402'] = { id:'star166402', unlocked:false, status:'new', spy:0, distance:17,    planets:3, faction:'prasnian', resource1:'helium',   resource2:'methane',   stats:{ 'power':539,  'defense':511,  'speed':10 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:170000 }], notifs:['interstellarPrasnianPane'], }
            state.data['star95001'] =  { id:'star95001',  unlocked:false, status:'new', spy:0, distance:17.71, planets:1, faction:'prasnian', resource1:'titanium', resource2:'meteorite', stats:{ 'power':595,  'defense':664,  'speed':8  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:177100 }], notifs:['interstellarPrasnianPane'], }
            state.data['star175902'] = { id:'star175902', unlocked:false, status:'new', spy:0, distance:17.98, planets:1, faction:'prasnian', resource1:'hydrogen', resource2:'wood',      stats:{ 'power':1247, 'defense':589,  'speed':9  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:179800 }], notifs:['interstellarPrasnianPane'], }
            state.data['star56501'] =  { id:'star56501',  unlocked:false, status:'new', spy:0, distance:19.19, planets:1, faction:'prasnian', resource1:'oil',      resource2:'gem',       stats:{ 'power':370,  'defense':507,  'speed':14 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:191900 }], notifs:['interstellarPrasnianPane'], }
            state.data['star167801'] = { id:'star167801', unlocked:false, status:'new', spy:0, distance:19.42, planets:1, faction:'prasnian', resource1:'oil',      resource2:'metal',     stats:{ 'power':762,  'defense':511,  'speed':15 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:194200 }], notifs:['interstellarPrasnianPane'], }
            state.data['star103201'] = { id:'star103201', unlocked:false, status:'new', spy:0, distance:20.26, planets:1, faction:'prasnian', resource1:'hydrogen', resource2:'methane',   stats:{ 'power':857,  'defense':927,  'speed':5  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:202600 }], notifs:['interstellarPrasnianPane'], }
            state.data['star113301'] = { id:'star113301', unlocked:false, status:'new', spy:0, distance:21.47, planets:2, faction:'prasnian', resource1:'hydrogen', resource2:'metal',     stats:{ 'power':1769, 'defense':631,  'speed':14 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:214700 }], notifs:['interstellarPrasnianPane'], }
            state.data['star199602'] = { id:'star199602', unlocked:false, status:'new', spy:0, distance:21.85, planets:2, faction:'prasnian', resource1:'silver',   resource2:'titanium',  stats:{ 'power':1518, 'defense':606,  'speed':5  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:218500 }], notifs:['interstellarPrasnianPane'], }
            state.data['star157201'] = { id:'star157201', unlocked:false, status:'new', spy:0, distance:24.91, planets:2, faction:'prasnian', resource1:'oil',      resource2:'methane',   stats:{ 'power':1093, 'defense':1746, 'speed':5  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:249100 }], notifs:['interstellarPrasnianPane'], }
            state.data['star222201'] = { id:'star222201', unlocked:false, status:'new', spy:0, distance:23.76, planets:1, faction:'prasnian', resource1:'uranium',  resource2:'silver',    stats:{ 'power':718,  'defense':863,  'speed':15 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:237600 }], notifs:['interstellarPrasnianPane'], }
            state.data['star6301'] =   { id:'star6301',   unlocked:false, status:'new', spy:0, distance:24.33, planets:3, faction:'prasnian', resource1:'titanium', resource2:'lava',      stats:{ 'power':1168, 'defense':722,  'speed':11 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:243300 }], notifs:['interstellarPrasnianPane'], }
            state.data['star214301'] = { id:'star214301', unlocked:false, status:'new', spy:0, distance:25.97, planets:1, faction:'prasnian', resource1:'carbon',   resource2:'uranium',   stats:{ 'power':1861, 'defense':1698, 'speed':14 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:259700 }], notifs:['interstellarPrasnianPane'], }
            state.data['star40801'] =  { id:'star40801',  unlocked:false, status:'new', spy:0, distance:26.07, planets:1, faction:'prasnian', resource1:'methane',  resource2:'metal',     stats:{ 'power':1566, 'defense':1944, 'speed':9  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:260700 }], notifs:['interstellarPrasnianPane'], }
            state.data['star207301'] = { id:'star207301', unlocked:false, status:'new', spy:0, distance:26.28, planets:1, faction:'prasnian', resource1:'titanium', resource2:'wood',      stats:{ 'power':944,  'defense':1168, 'speed':5  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:262800 }], notifs:['interstellarPrasnianPane'], }
            state.data['star169601'] = { id:'star169601', unlocked:false, status:'new', spy:0, distance:26.57, planets:1, faction:'prasnian', resource1:'gem',      resource2:'silicon',   stats:{ 'power':1903, 'defense':1859, 'speed':13 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:265700 }], notifs:['interstellarPrasnianPane'], }
            state.data['star157101'] = { id:'star157101', unlocked:false, status:'new', spy:0, distance:28.11, planets:4, faction:'prasnian', resource1:'oil',      resource2:'helium',    stats:{ 'power':1781, 'defense':1088, 'speed':6  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:281100 }], notifs:['interstellarPrasnianPane'], }
            state.data['star178501'] = { id:'star178501', unlocked:false, status:'new', spy:0, distance:28.26, planets:2, faction:'prasnian', resource1:'hydrogen', resource2:'uranium',   stats:{ 'power':2207, 'defense':1031, 'speed':6  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:282600 }], notifs:['interstellarPrasnianPane'], }
            state.data['star208601'] = { id:'star208601', unlocked:false, status:'new', spy:0, distance:28.91, planets:2, faction:'prasnian', resource1:'carbon',   resource2:'methane',   stats:{ 'power':2312, 'defense':2295, 'speed':13 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:289100 }], notifs:['interstellarPrasnianPane'], }
            state.data['star78101'] =  { id:'star78101',  unlocked:false, status:'new', spy:0, distance:29.48, planets:1, faction:'prasnian', resource1:'wood',     resource2:'hydrogen',  stats:{ 'power':1211, 'defense':2494, 'speed':15 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:294800 }], notifs:['interstellarPrasnianPane'], }
            state.data['star123501'] = { id:'star123501', unlocked:false, status:'new', spy:0, distance:30.95, planets:1, faction:'prasnian', resource1:'carbon',   resource2:'carbon',    stats:{ 'power':2844, 'defense':1816, 'speed':12 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:309500 }], notifs:['interstellarPrasnianPane'], }
            state.data['star85901'] =  { id:'star85901',  unlocked:false, status:'new', spy:0, distance:31.5,  planets:3, faction:'prasnian', resource1:'lunarite', resource2:'metal',     stats:{ 'power':1673, 'defense':1609, 'speed':15 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:315000 }], notifs:['interstellarPrasnianPane'], }
            state.data['star18501'] =  { id:'star18501',  unlocked:false, status:'new', spy:0, distance:31.85, planets:4, faction:'prasnian', resource1:'wood',     resource2:'meteorite', stats:{ 'power':1368, 'defense':2485, 'speed':6  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:318500 }], notifs:['interstellarPrasnianPane'], }
            state.data['star199801'] = { id:'star199801', unlocked:false, status:'new', spy:0, distance:32.01, planets:5, faction:'prasnian', resource1:'uranium',  resource2:'silver',    stats:{ 'power':3811, 'defense':1989, 'speed':7  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:320100 }], notifs:['interstellarPrasnianPane'], }
            state.data['star141901'] = { id:'star141901', unlocked:false, status:'new', spy:0, distance:32.1,  planets:4, faction:'prasnian', resource1:'gem',      resource2:'metal',     stats:{ 'power':2373, 'defense':2562, 'speed':8  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:321000 }], notifs:['interstellarPrasnianPane'], }
            state.data['star5201'] =   { id:'star5201',   unlocked:false, status:'new', spy:0, distance:32.36, planets:1, faction:'prasnian', resource1:'methane',  resource2:'ice',       stats:{ 'power':2105, 'defense':2952, 'speed':14 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:323600 }], notifs:['interstellarPrasnianPane'], }
            state.data['star223701'] = { id:'star223701', unlocked:false, status:'new', spy:0, distance:32.98, planets:2, faction:'prasnian', resource1:'helium',   resource2:'gold',      stats:{ 'power':3065, 'defense':2290, 'speed':8  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:329800 }], notifs:['interstellarPrasnianPane'], }
            state.data['star166903'] = { id:'star166903', unlocked:false, status:'new', spy:0, distance:33.03, planets:3, faction:'prasnian', resource1:'silicon',  resource2:'methane',   stats:{ 'power':3965, 'defense':2348, 'speed':7  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:330300 }], notifs:['interstellarPrasnianPane'], }
            state.data['star32101'] =  { id:'star32101',  unlocked:false, status:'new', spy:0, distance:33.24, planets:2, faction:'prasnian', resource1:'silver',   resource2:'meteorite', stats:{ 'power':2028, 'defense':2434, 'speed':11 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:332400 }], notifs:['interstellarPrasnianPane'], }
            state.data['star77801'] =  { id:'star77801',  unlocked:false, status:'new', spy:0, distance:34.17, planets:3, faction:'prasnian', resource1:'uranium',  resource2:'hydrogen',  stats:{ 'power':3402, 'defense':2740, 'speed':14 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:341700 }], notifs:['interstellarPrasnianPane'], }
            state.data['star205201'] = { id:'star205201', unlocked:false, status:'new', spy:0, distance:34.96, planets:2, faction:'prasnian', resource1:'uranium',  resource2:'lava',      stats:{ 'power':2987, 'defense':2014, 'speed':13 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:349600 }], notifs:['interstellarPrasnianPane'], }
            /*----------------------------------------------------------------*/
            
            // HYACINITE STARS
            /*----------------------------------------------------------------*/
            state.data['star201'] =    { id:'star201',    unlocked:false, status:'new', spy:0, distance:4.3,   planets:1, faction:'hyacinite', resource1:'ice',       resource2:'hydrogen',  stats:{ 'power':30,   'defense':20,   'speed':5  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:43000  }], notifs:['interstellarHyacinitePane'], }
            state.data['star217101'] = { id:'star217101', unlocked:false, status:'new', spy:0, distance:11.08, planets:1, faction:'hyacinite', resource1:'silver',    resource2:'metal',     stats:{ 'power':420,  'defense':143,  'speed':12 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:110800 }], notifs:['interstellarHyacinitePane'], }
            state.data['star166701'] = { id:'star166701', unlocked:false, status:'new', spy:0, distance:11.64, planets:5, faction:'hyacinite', resource1:'meteorite', resource2:'silver',    stats:{ 'power':331,  'defense':286,  'speed':6  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:116400 }], notifs:['interstellarHyacinitePane'], }
            state.data['star179501'] = { id:'star179501', unlocked:false, status:'new', spy:0, distance:13.47, planets:1, faction:'hyacinite', resource1:'carbon',    resource2:'lava',      stats:{ 'power':430,  'defense':411,  'speed':7  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:134700 }], notifs:['interstellarHyacinitePane'], }
            state.data['star6501'] =   { id:'star6501',   unlocked:false, status:'new', spy:0, distance:14.13, planets:1, faction:'hyacinite', resource1:'gold',      resource2:'silicon',   stats:{ 'power':588,  'defense':522,  'speed':8  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:141300 }], notifs:['interstellarHyacinitePane'], }
            state.data['star222401'] = { id:'star222401', unlocked:false, status:'new', spy:0, distance:14.65, planets:1, faction:'hyacinite', resource1:'lava',      resource2:'methane',   stats:{ 'power':527,  'defense':239,  'speed':6  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:146500 }], notifs:['interstellarHyacinitePane'], }
            state.data['star200001'] = { id:'star200001', unlocked:false, status:'new', spy:0, distance:19.26, planets:4, faction:'hyacinite', resource1:'gold',      resource2:'meteorite', stats:{ 'power':1176, 'defense':612,  'speed':10 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:192600 }], notifs:['interstellarHyacinitePane'], }
            state.data['star24201'] =  { id:'star24201',  unlocked:false, status:'new', spy:0, distance:19.77, planets:5, faction:'hyacinite', resource1:'gold',      resource2:'lunarite',  stats:{ 'power':595,  'defense':956,  'speed':14 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:197700 }], notifs:['interstellarHyacinitePane'], }
            state.data['star224202'] = { id:'star224202', unlocked:false, status:'new', spy:0, distance:22.37, planets:2, faction:'hyacinite', resource1:'titanium',  resource2:'hydrogen',  stats:{ 'power':1841, 'defense':1155, 'speed':10 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:223700 }], notifs:['interstellarHyacinitePane'], }
            state.data['star92801'] =  { id:'star92801',  unlocked:false, status:'new', spy:0, distance:24.88, planets:3, faction:'hyacinite', resource1:'methane',   resource2:'carbon',    stats:{ 'power':2461, 'defense':1301, 'speed':7  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:248800 }], notifs:['interstellarHyacinitePane'], }
            state.data['star172701'] = { id:'star172701', unlocked:false, status:'new', spy:0, distance:24.9,  planets:2, faction:'hyacinite', resource1:'methane',   resource2:'helium',    stats:{ 'power':2333, 'defense':972,  'speed':6  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:249000 }], notifs:['interstellarHyacinitePane'], }
            state.data['star86401'] =  { id:'star86401',  unlocked:false, status:'new', spy:0, distance:24.99, planets:1, faction:'hyacinite', resource1:'titanium',  resource2:'lunarite',  stats:{ 'power':1867, 'defense':920,  'speed':8  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:249900 }], notifs:['interstellarHyacinitePane'], }
            state.data['star202902'] = { id:'star202902', unlocked:false, status:'new', spy:0, distance:27.63, planets:5, faction:'hyacinite', resource1:'gem',       resource2:'metal',     stats:{ 'power':1261, 'defense':1135, 'speed':5  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:276300 }], notifs:['interstellarHyacinitePane'], }
            state.data['star177001'] = { id:'star177001', unlocked:false, status:'new', spy:0, distance:27.79, planets:3, faction:'hyacinite', resource1:'carbon',    resource2:'hydrogen',  stats:{ 'power':1184, 'defense':2279, 'speed':12 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:277900 }], notifs:['interstellarHyacinitePane'], }
            state.data['star68301'] =  { id:'star68301',  unlocked:false, status:'new', spy:0, distance:27.81, planets:3, faction:'hyacinite', resource1:'ice',       resource2:'uranium',   stats:{ 'power':2065, 'defense':958,  'speed':10 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:278100 }], notifs:['interstellarHyacinitePane'], }
            state.data['star205001'] = { id:'star205001', unlocked:false, status:'new', spy:0, distance:28.66, planets:2, faction:'hyacinite', resource1:'uranium',   resource2:'silver',    stats:{ 'power':2555, 'defense':1812, 'speed':7  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:286600 }], notifs:['interstellarHyacinitePane'], }
            state.data['star13401'] =  { id:'star13401',  unlocked:false, status:'new', spy:0, distance:28.66, planets:2, faction:'hyacinite', resource1:'silicon',   resource2:'metal',     stats:{ 'power':2684, 'defense':902,  'speed':7  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:286600 }], notifs:['interstellarHyacinitePane'], }
            state.data['star34201'] =  { id:'star34201',  unlocked:false, status:'new', spy:0, distance:28.75, planets:5, faction:'hyacinite', resource1:'carbon',    resource2:'silver',    stats:{ 'power':3086, 'defense':1715, 'speed':6  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:287500 }], notifs:['interstellarHyacinitePane'], }
            state.data['star182101'] = { id:'star182101', unlocked:false, status:'new', spy:0, distance:29.12, planets:1, faction:'hyacinite', resource1:'silicon',   resource2:'gold',      stats:{ 'power':1192, 'defense':1832, 'speed':6  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:291200 }], notifs:['interstellarHyacinitePane'], }
            state.data['star178401'] = { id:'star178401', unlocked:false, status:'new', spy:0, distance:29.25, planets:3, faction:'hyacinite', resource1:'silver',    resource2:'hydrogen',  stats:{ 'power':3295, 'defense':1540, 'speed':13 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:292500 }], notifs:['interstellarHyacinitePane'], }
            state.data['star107601'] = { id:'star107601', unlocked:false, status:'new', spy:0, distance:29.38, planets:5, faction:'hyacinite', resource1:'helium',    resource2:'silicon',   stats:{ 'power':2195, 'defense':1127, 'speed':5  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:293800 }], notifs:['interstellarHyacinitePane'], }
            state.data['star192101'] = { id:'star192101', unlocked:false, status:'new', spy:0, distance:29.87, planets:5, faction:'hyacinite', resource1:'wood',      resource2:'carbon',    stats:{ 'power':2350, 'defense':2425, 'speed':9  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:298700 }], notifs:['interstellarHyacinitePane'], }
            state.data['star24001'] =  { id:'star24001',  unlocked:false, status:'new', spy:0, distance:29.87, planets:1, faction:'hyacinite', resource1:'lava',      resource2:'helium',    stats:{ 'power':1036, 'defense':1460, 'speed':12 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:298700 }], notifs:['interstellarHyacinitePane'], }
            state.data['star16601'] =  { id:'star16601',  unlocked:false, status:'new', spy:0, distance:30.06, planets:1, faction:'hyacinite', resource1:'hydrogen',  resource2:'gem',       stats:{ 'power':1761, 'defense':1234, 'speed':5  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:300600 }], notifs:['interstellarHyacinitePane'], }
            state.data['star27501'] =  { id:'star27501',  unlocked:false, status:'new', spy:0, distance:31.36, planets:2, faction:'hyacinite', resource1:'helium',    resource2:'ice',       stats:{ 'power':1490, 'defense':1216, 'speed':15 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:313600 }], notifs:['interstellarHyacinitePane'], }
            state.data['star121601'] = { id:'star121601', unlocked:false, status:'new', spy:0, distance:31.88, planets:1, faction:'hyacinite', resource1:'metal',     resource2:'ice',       stats:{ 'power':1751, 'defense':2344, 'speed':15 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:318800 }], notifs:['interstellarHyacinitePane'], }
            state.data['star212102'] = { id:'star212102', unlocked:false, status:'new', spy:0, distance:33.35, planets:4, faction:'hyacinite', resource1:'gold',      resource2:'ice',       stats:{ 'power':1144, 'defense':1466, 'speed':7  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:333500 }], notifs:['interstellarHyacinitePane'], }
            state.data['star117501'] = { id:'star117501', unlocked:false, status:'new', spy:0, distance:33.66, planets:1, faction:'hyacinite', resource1:'silver',    resource2:'carbon',    stats:{ 'power':2373, 'defense':2370, 'speed':7  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:336600 }], notifs:['interstellarHyacinitePane'], }
            /*----------------------------------------------------------------*/

            // KITRINOS STARS
            /*----------------------------------------------------------------*/
            state.data['star501'] =    { id:'star501',    unlocked:false, status:'new', spy:0, distance:8.31,  planets:1, faction:'kitrinos', resource1:'titanium',  resource2:'silicon',   stats:{ 'power':132,  'defense':117,  'speed':8  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:83100  }], notifs:['interstellarKitrinosPane'], }
            state.data['star130601'] = { id:'star130601', unlocked:false, status:'new', spy:0, distance:9.69,  planets:2, faction:'kitrinos', resource1:'gold',      resource2:'lava',      stats:{ 'power':144,  'defense':229,  'speed':12 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:96900  }], notifs:['interstellarKitrinosPane'], }
            state.data['star158101'] = { id:'star158101', unlocked:false, status:'new', spy:0, distance:10.73, planets:5, faction:'kitrinos', resource1:'oil',       resource2:'lava',      stats:{ 'power':443,  'defense':147,  'speed':7  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:107300 }], notifs:['interstellarKitrinosPane'], }
            state.data['star224601'] = { id:'star224601', unlocked:false, status:'new', spy:0, distance:11.8,  planets:1, faction:'kitrinos', resource1:'methane',   resource2:'gold',      stats:{ 'power':513,  'defense':164,  'speed':9  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:118000 }], notifs:['interstellarKitrinosPane'], }
            state.data['star58601'] =  { id:'star58601',  unlocked:false, status:'new', spy:0, distance:11.83, planets:4, faction:'kitrinos', resource1:'helium',    resource2:'methane',   stats:{ 'power':427,  'defense':184,  'speed':11 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:118300 }], notifs:['interstellarKitrinosPane'], }
            state.data['star10101'] =  { id:'star10101',  unlocked:false, status:'new', spy:0, distance:12.2,  planets:1, faction:'kitrinos', resource1:'gold',      resource2:'hydrogen',  stats:{ 'power':506,  'defense':334,  'speed':15 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:122000 }], notifs:['interstellarKitrinosPane'], }
            state.data['star194201'] = { id:'star194201', unlocked:false, status:'new', spy:0, distance:14.05, planets:1, faction:'kitrinos', resource1:'silver',    resource2:'lava',      stats:{ 'power':460,  'defense':465,  'speed':10 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:140500 }], notifs:['interstellarKitrinosPane'], }
            state.data['star1101'] =   { id:'star1101',   unlocked:false, status:'new', spy:0, distance:14.22, planets:3, faction:'kitrinos', resource1:'silicon',   resource2:'methane',   stats:{ 'power':779,  'defense':410,  'speed':10 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:142200 }], notifs:['interstellarKitrinosPane'], }
            state.data['star72501'] =  { id:'star72501',  unlocked:false, status:'new', spy:0, distance:14.76, planets:4, faction:'kitrinos', resource1:'uranium',   resource2:'lava',      stats:{ 'power':620,  'defense':612,  'speed':15 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:147600 }], notifs:['interstellarKitrinosPane'], }
            state.data['star210501'] = { id:'star210501', unlocked:false, status:'new', spy:0, distance:15.39, planets:1, faction:'kitrinos', resource1:'meteorite', resource2:'meteorite', stats:{ 'power':479,  'defense':563,  'speed':14 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:153900 }], notifs:['interstellarKitrinosPane'], }
            state.data['star189701'] = { id:'star189701', unlocked:false, status:'new', spy:0, distance:15.76, planets:1, faction:'kitrinos', resource1:'helium',    resource2:'gold',      stats:{ 'power':708,  'defense':278,  'speed':10 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:157600 }], notifs:['interstellarKitrinosPane'], }
            state.data['star175601'] = { id:'star175601', unlocked:false, status:'new', spy:0, distance:16.45, planets:4, faction:'kitrinos', resource1:'wood',      resource2:'meteorite', stats:{ 'power':411,  'defense':544,  'speed':15 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:164500 }], notifs:['interstellarKitrinosPane'], }
            state.data['star206902'] = { id:'star206902', unlocked:false, status:'new', spy:0, distance:16.59, planets:5, faction:'kitrinos', resource1:'hydrogen',  resource2:'carbon',    stats:{ 'power':602,  'defense':555,  'speed':11 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:165900 }], notifs:['interstellarKitrinosPane'], }
            state.data['star133601'] = { id:'star133601', unlocked:false, status:'new', spy:0, distance:18.56, planets:3, faction:'kitrinos', resource1:'titanium',  resource2:'methane',   stats:{ 'power':471,  'defense':749,  'speed':8  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:185600 }], notifs:['interstellarKitrinosPane'], }
            state.data['star135801'] = { id:'star135801', unlocked:false, status:'new', spy:0, distance:18.81, planets:1, faction:'kitrinos', resource1:'uranium',   resource2:'meteorite', stats:{ 'power':635,  'defense':664,  'speed':12 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:188100 }], notifs:['interstellarKitrinosPane'], }
            state.data['star39101'] =  { id:'star39101',  unlocked:false, status:'new', spy:0, distance:18.88, planets:1, faction:'kitrinos', resource1:'ice',       resource2:'lunarite',  stats:{ 'power':1396, 'defense':698,  'speed':14 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:188800 }], notifs:['interstellarKitrinosPane'], }
            state.data['star107001'] = { id:'star107001', unlocked:false, status:'new', spy:0, distance:19.35, planets:2, faction:'kitrinos', resource1:'gold',      resource2:'hydrogen',  stats:{ 'power':805,  'defense':587,  'speed':11 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:193500 }], notifs:['interstellarKitrinosPane'], }
            state.data['star105801'] = { id:'star105801', unlocked:false, status:'new', spy:0, distance:20.45, planets:3, faction:'kitrinos', resource1:'lunarite',  resource2:'hydrogen',  stats:{ 'power':1478, 'defense':1182, 'speed':7  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:204500 }], notifs:['interstellarKitrinosPane'], }
            state.data['star224201'] = { id:'star224201', unlocked:false, status:'new', spy:0, distance:22.37, planets:1, faction:'kitrinos', resource1:'silver',    resource2:'metal',     stats:{ 'power':1275, 'defense':672,  'speed':11 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:223700 }], notifs:['interstellarKitrinosPane'], }
            state.data['star205101'] = { id:'star205101', unlocked:false, status:'new', spy:0, distance:22.74, planets:1, faction:'kitrinos', resource1:'helium',    resource2:'titanium',  stats:{ 'power':747,  'defense':1117, 'speed':11 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:227400 }], notifs:['interstellarKitrinosPane'], }
            state.data['star162501'] = { id:'star162501', unlocked:false, status:'new', spy:0, distance:23.53, planets:5, faction:'kitrinos', resource1:'oil',       resource2:'meteorite', stats:{ 'power':1393, 'defense':773,  'speed':5  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:235300 }], notifs:['interstellarKitrinosPane'], }
            state.data['star4001'] =   { id:'star4001',   unlocked:false, status:'new', spy:0, distance:24.38, planets:4, faction:'kitrinos', resource1:'ice',       resource2:'silicon',   stats:{ 'power':1337, 'defense':775,  'speed':14 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:243800 }], notifs:['interstellarKitrinosPane'], }
            state.data['star141101'] = { id:'star141101', unlocked:false, status:'new', spy:0, distance:25.96, planets:1, faction:'kitrinos', resource1:'ice',       resource2:'lunarite',  stats:{ 'power':2177, 'defense':1625, 'speed':11 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:259600 }], notifs:['interstellarKitrinosPane'], }
            state.data['star180502'] = { id:'star180502', unlocked:false, status:'new', spy:0, distance:26.17, planets:2, faction:'kitrinos', resource1:'wood',      resource2:'metal',     stats:{ 'power':1908, 'defense':980,  'speed':11 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:261700 }], notifs:['interstellarKitrinosPane'], }
            state.data['star208702'] = { id:'star208702', unlocked:false, status:'new', spy:0, distance:26.6,  planets:1, faction:'kitrinos', resource1:'silicon',   resource2:'wood',      stats:{ 'power':1034, 'defense':1838, 'speed':10 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:266000 }], notifs:['interstellarKitrinosPane'], }
            state.data['star85501'] =  { id:'star85501',  unlocked:false, status:'new', spy:0, distance:27.3,  planets:2, faction:'kitrinos', resource1:'meteorite', resource2:'titanium',  stats:{ 'power':1049, 'defense':1778, 'speed':8  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:273000 }], notifs:['interstellarKitrinosPane'], }
            state.data['star217202'] = { id:'star217202', unlocked:false, status:'new', spy:0, distance:28.19, planets:1, faction:'kitrinos', resource1:'meteorite', resource2:'uranium',   stats:{ 'power':2289, 'defense':1983, 'speed':15 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:281900 }], notifs:['interstellarKitrinosPane'], }
            state.data['star180101'] = { id:'star180101', unlocked:false, status:'new', spy:0, distance:28.38, planets:3, faction:'kitrinos', resource1:'methane',   resource2:'gem',       stats:{ 'power':1870, 'defense':1624, 'speed':8  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:283800 }], notifs:['interstellarKitrinosPane'], }
            state.data['star13801'] =  { id:'star13801',  unlocked:false, status:'new', spy:0, distance:32.54, planets:4, faction:'kitrinos', resource1:'carbon',    resource2:'gold',      stats:{ 'power':3103, 'defense':2163, 'speed':12 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:325400 }], notifs:['interstellarKitrinosPane'], }
            state.data['star37101'] =  { id:'star37101',  unlocked:false, status:'new', spy:0, distance:32.71, planets:1, faction:'kitrinos', resource1:'silver',    resource2:'silver',    stats:{ 'power':3279, 'defense':2710, 'speed':10 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:327100 }], notifs:['interstellarKitrinosPane'], }
            state.data['star42501'] =  { id:'star42501',  unlocked:false, status:'new', spy:0, distance:33.1,  planets:1, faction:'kitrinos', resource1:'gold',      resource2:'hydrogen',  stats:{ 'power':3316, 'defense':3166, 'speed':11 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:331000 }], notifs:['interstellarKitrinosPane'], }
            state.data['star80901'] =  { id:'star80901',  unlocked:false, status:'new', spy:0, distance:33.23, planets:4, faction:'kitrinos', resource1:'methane',   resource2:'titanium',  stats:{ 'power':1455, 'defense':3056, 'speed':6  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:332300 }], notifs:['interstellarKitrinosPane'], }
            state.data['star215902'] = { id:'star215902', unlocked:false, status:'new', spy:0, distance:33.25, planets:4, faction:'kitrinos', resource1:'uranium',   resource2:'titanium',  stats:{ 'power':4146, 'defense':2027, 'speed':8  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:332500 }], notifs:['interstellarKitrinosPane'], }
            state.data['star190502'] = { id:'star190502', unlocked:false, status:'new', spy:0, distance:33.98, planets:5, faction:'kitrinos', resource1:'silver',    resource2:'lunarite',  stats:{ 'power':3897, 'defense':1867, 'speed':6  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:339800 }], notifs:['interstellarKitrinosPane'], }
            state.data['star99701'] =  { id:'star99701',  unlocked:false, status:'new', spy:0, distance:34.33, planets:4, faction:'kitrinos', resource1:'ice',       resource2:'ice',       stats:{ 'power':3812, 'defense':2495, 'speed':10 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:343300 }], notifs:['interstellarKitrinosPane'], }
            state.data['star176802'] = { id:'star176802', unlocked:false, status:'new', spy:0, distance:34.33, planets:5, faction:'kitrinos', resource1:'gem',       resource2:'titanium',  stats:{ 'power':4481, 'defense':2620, 'speed':13 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:343300 }], notifs:['interstellarKitrinosPane'], }
            /*----------------------------------------------------------------*/

            // MOVITON STARS
            /*----------------------------------------------------------------*/
            state.data['star701'] =    { id:'star701',    unlocked:false, status:'new', spy:0, distance:8.55,  planets:1, faction:'moviton', resource1:'carbon',    resource2:'methane',   stats:{ 'power':146,  'defense':131,  'speed':10 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:85500  }], notifs:['interstellarMovitonPane'], }
            state.data['star601'] =    { id:'star601',    unlocked:false, status:'new', spy:0, distance:8.6,   planets:5, faction:'moviton', resource1:'silicon',   resource2:'methane',   stats:{ 'power':110,  'defense':129,  'speed':8  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:86000  }], notifs:['interstellarMovitonPane'], }
            state.data['star80101'] =  { id:'star80101',  unlocked:false, status:'new', spy:0, distance:10.89, planets:4, faction:'moviton', resource1:'hydrogen',  resource2:'helium',    stats:{ 'power':125,  'defense':198,  'speed':11 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:108900 }], notifs:['interstellarMovitonPane'], }
            state.data['star213301'] = { id:'star213301', unlocked:false, status:'new', spy:0, distance:11.43, planets:5, faction:'moviton', resource1:'uranium',   resource2:'ice',       stats:{ 'power':289,  'defense':177,  'speed':11 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:114300 }], notifs:['interstellarMovitonPane'], }
            state.data['star13601'] =  { id:'star13601',  unlocked:false, status:'new', spy:0, distance:11.9,  planets:4, faction:'moviton', resource1:'silicon',   resource2:'silicon',   stats:{ 'power':491,  'defense':413,  'speed':6  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:119000 }], notifs:['interstellarMovitonPane'], }
            state.data['star51801'] =  { id:'star51801',  unlocked:false, status:'new', spy:0, distance:12.39, planets:1, faction:'moviton', resource1:'uranium',   resource2:'titanium',  stats:{ 'power':320,  'defense':355,  'speed':7  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:123900 }], notifs:['interstellarMovitonPane'], }
            state.data['star35801'] =  { id:'star35801',  unlocked:false, status:'new', spy:0, distance:12.78, planets:1, faction:'moviton', resource1:'lava',      resource2:'silver',    stats:{ 'power':468,  'defense':285,  'speed':10 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:127800 }], notifs:['interstellarMovitonPane'], }
            state.data['star216801'] = { id:'star216801', unlocked:false, status:'new', spy:0, distance:13.07, planets:4, faction:'moviton', resource1:'lunarite',  resource2:'ice',       stats:{ 'power':526,  'defense':490,  'speed':9  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:130700 }], notifs:['interstellarMovitonPane'], }
            state.data['star224101'] = { id:'star224101', unlocked:false, status:'new', spy:0, distance:13.16, planets:1, faction:'moviton', resource1:'wood',      resource2:'metal',     stats:{ 'power':587,  'defense':285,  'speed':12 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:131600 }], notifs:['interstellarMovitonPane'], }
            state.data['star114001'] = { id:'star114001', unlocked:false, status:'new', spy:0, distance:13.91, planets:5, faction:'moviton', resource1:'metal',     resource2:'meteorite', stats:{ 'power':705,  'defense':479,  'speed':11 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:139100 }], notifs:['interstellarMovitonPane'], }
            state.data['star15301'] =  { id:'star15301',  unlocked:false, status:'new', spy:0, distance:14.57, planets:2, faction:'moviton', resource1:'metal',     resource2:'hydrogen',  stats:{ 'power':568,  'defense':229,  'speed':15 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:145700 }], notifs:['interstellarMovitonPane'], }
            state.data['star69601'] =  { id:'star69601',  unlocked:false, status:'new', spy:0, distance:16,    planets:2, faction:'moviton', resource1:'gem',       resource2:'titanium',  stats:{ 'power':657,  'defense':767,  'speed':10 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:160000 }], notifs:['interstellarMovitonPane'], }
            state.data['star148501'] = { id:'star148501', unlocked:false, status:'new', spy:0, distance:16.1,  planets:2, faction:'moviton', resource1:'oil',       resource2:'methane',   stats:{ 'power':443,  'defense':384,  'speed':15 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:161000 }], notifs:['interstellarMovitonPane'], }
            state.data['star155801'] = { id:'star155801', unlocked:false, status:'new', spy:0, distance:16.47, planets:3, faction:'moviton', resource1:'ice',       resource2:'meteorite', stats:{ 'power':633,  'defense':589,  'speed':5  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:164700 }], notifs:['interstellarMovitonPane'], }
            state.data['star185101'] = { id:'star185101', unlocked:false, status:'new', spy:0, distance:17.05, planets:1, faction:'moviton', resource1:'gold',      resource2:'gold',      stats:{ 'power':802,  'defense':792,  'speed':10 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:170500 }], notifs:['interstellarMovitonPane'], }
            state.data['star175901'] = { id:'star175901', unlocked:false, status:'new', spy:0, distance:17.98, planets:1, faction:'moviton', resource1:'helium',    resource2:'meteorite', stats:{ 'power':540,  'defense':332,  'speed':12 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:179800 }], notifs:['interstellarMovitonPane'], }
            state.data['star203902'] = { id:'star203902', unlocked:false, status:'new', spy:0, distance:18.72, planets:5, faction:'moviton', resource1:'wood',      resource2:'uranium',   stats:{ 'power':873,  'defense':1048, 'speed':11 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:187200 }], notifs:['interstellarMovitonPane'], }
            state.data['star204801'] = { id:'star204801', unlocked:false, status:'new', spy:0, distance:19.47, planets:2, faction:'moviton', resource1:'silicon',   resource2:'gem',       stats:{ 'power':1496, 'defense':1070, 'speed':13 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:194700 }], notifs:['interstellarMovitonPane'], }
            state.data['star211202'] = { id:'star211202', unlocked:false, status:'new', spy:0, distance:19.74, planets:3, faction:'moviton', resource1:'methane',   resource2:'silver',    stats:{ 'power':1331, 'defense':554,  'speed':14 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:197400 }], notifs:['interstellarMovitonPane'], }
            state.data['star100801'] = { id:'star100801', unlocked:false, status:'new', spy:0, distance:19.95, planets:1, faction:'moviton', resource1:'metal',     resource2:'titanium',  stats:{ 'power':1095, 'defense':685,  'speed':8  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:199500 }], notifs:['interstellarMovitonPane'], }
            state.data['star124101'] = { id:'star124101', unlocked:false, status:'new', spy:0, distance:20.03, planets:4, faction:'moviton', resource1:'hydrogen',  resource2:'ice',       stats:{ 'power':863,  'defense':583,  'speed':6  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:200300 }], notifs:['interstellarMovitonPane'], }
            state.data['star139701'] = { id:'star139701', unlocked:false, status:'new', spy:0, distance:20.24, planets:1, faction:'moviton', resource1:'methane',   resource2:'silicon',   stats:{ 'power':1624, 'defense':1208, 'speed':12 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:202400 }], notifs:['interstellarMovitonPane'], }
            state.data['star50401'] =  { id:'star50401',  unlocked:false, status:'new', spy:0, distance:20.74, planets:1, faction:'moviton', resource1:'lava',      resource2:'gem',       stats:{ 'power':1439, 'defense':863,  'speed':12 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:207400 }], notifs:['interstellarMovitonPane'], }
            state.data['star159101'] = { id:'star159101', unlocked:false, status:'new', spy:0, distance:21.28, planets:4, faction:'moviton', resource1:'helium',    resource2:'lunarite',  stats:{ 'power':830,  'defense':652,  'speed':6  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:212800 }], notifs:['interstellarMovitonPane'], }
            state.data['star148101'] = { id:'star148101', unlocked:false, status:'new', spy:0, distance:21.99, planets:1, faction:'moviton', resource1:'carbon',    resource2:'gem',       stats:{ 'power':1817, 'defense':977,  'speed':5  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:219900 }], notifs:['interstellarMovitonPane'], }
            state.data['star157301'] = { id:'star157301', unlocked:false, status:'new', spy:0, distance:22.45, planets:1, faction:'moviton', resource1:'silicon',   resource2:'ice',       stats:{ 'power':852,  'defense':606,  'speed':13 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:224500 }], notifs:['interstellarMovitonPane'], }
            state.data['star72601'] =  { id:'star72601',  unlocked:false, status:'new', spy:0, distance:22.48, planets:3, faction:'moviton', resource1:'hydrogen',  resource2:'silver',    stats:{ 'power':1244, 'defense':1466, 'speed':15 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:224800 }], notifs:['interstellarMovitonPane'], }
            state.data['star224801'] = { id:'star224801', unlocked:false, status:'new', spy:0, distance:23.5,  planets:3, faction:'moviton', resource1:'silicon',   resource2:'titanium',  stats:{ 'power':1608, 'defense':566,  'speed':14 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:235000 }], notifs:['interstellarMovitonPane'], }
            state.data['star71001'] =  { id:'star71001',  unlocked:false, status:'new', spy:0, distance:23.59, planets:3, faction:'moviton', resource1:'helium',    resource2:'silver',    stats:{ 'power':792,  'defense':1615, 'speed':12 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:235900 }], notifs:['interstellarMovitonPane'], }
            state.data['star207501'] = { id:'star207501', unlocked:false, status:'new', spy:0, distance:23.98, planets:3, faction:'moviton', resource1:'metal',     resource2:'carbon',    stats:{ 'power':713,  'defense':1513, 'speed':13 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:239800 }], notifs:['interstellarMovitonPane'], }
            state.data['star168302'] = { id:'star168302', unlocked:false, status:'new', spy:0, distance:24.63, planets:1, faction:'moviton', resource1:'ice',       resource2:'oil',       stats:{ 'power':2228, 'defense':1446, 'speed':13 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:246300 }], notifs:['interstellarMovitonPane'], }
            state.data['star128901'] = { id:'star128901', unlocked:false, status:'new', spy:0, distance:25.3,  planets:4, faction:'moviton', resource1:'helium',    resource2:'methane',   stats:{ 'power':2389, 'defense':1753, 'speed':6  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:253000 }], notifs:['interstellarMovitonPane'], }
            state.data['star68401'] =  { id:'star68401',  unlocked:false, status:'new', spy:0, distance:25.48, planets:1, faction:'moviton', resource1:'oil',       resource2:'meteorite', stats:{ 'power':2297, 'defense':1156, 'speed':9  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:254800 }], notifs:['interstellarMovitonPane'], }
            state.data['star30701'] =  { id:'star30701',  unlocked:false, status:'new', spy:0, distance:26.52, planets:1, faction:'moviton', resource1:'wood',      resource2:'carbon',    stats:{ 'power':1231, 'defense':1786, 'speed':11 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:265200 }], notifs:['interstellarMovitonPane'], }
            state.data['star193402'] = { id:'star193402', unlocked:false, status:'new', spy:0, distance:27.59, planets:3, faction:'moviton', resource1:'hydrogen',  resource2:'carbon',    stats:{ 'power':1250, 'defense':1062, 'speed':11 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:275900 }], notifs:['interstellarMovitonPane'], }
            state.data['star84201'] =  { id:'star84201',  unlocked:false, status:'new', spy:0, distance:28.99, planets:4, faction:'moviton', resource1:'hydrogen',  resource2:'methane',   stats:{ 'power':2628, 'defense':1914, 'speed':6  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:289900 }], notifs:['interstellarMovitonPane'], }
            state.data['star76401'] =  { id:'star76401',  unlocked:false, status:'new', spy:0, distance:29.66, planets:4, faction:'moviton', resource1:'titanium',  resource2:'carbon',    stats:{ 'power':2969, 'defense':1045, 'speed':11 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:296600 }], notifs:['interstellarMovitonPane'], }
            state.data['star32301'] =  { id:'star32301',  unlocked:false, status:'new', spy:0, distance:31.03, planets:5, faction:'moviton', resource1:'wood',      resource2:'wood',      stats:{ 'power':1018, 'defense':1797, 'speed':8  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:310300 }], notifs:['interstellarMovitonPane'], }
            state.data['star191401'] = { id:'star191401', unlocked:false, status:'new', spy:0, distance:31.11, planets:1, faction:'moviton', resource1:'meteorite', resource2:'uranium',   stats:{ 'power':3584, 'defense':2215, 'speed':15 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:311100 }], notifs:['interstellarMovitonPane'], }
            state.data['star118301'] = { id:'star118301', unlocked:false, status:'new', spy:0, distance:31.18, planets:4, faction:'moviton', resource1:'gold',      resource2:'wood',      stats:{ 'power':3351, 'defense':2096, 'speed':13 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:311800 }], notifs:['interstellarMovitonPane'], }
            state.data['star166901'] = { id:'star166901', unlocked:false, status:'new', spy:0, distance:33.03, planets:2, faction:'moviton', resource1:'gem',       resource2:'silver',    stats:{ 'power':3696, 'defense':1445, 'speed':14 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:330300 }], notifs:['interstellarMovitonPane'], }
            state.data['star62901'] =  { id:'star62901',  unlocked:false, status:'new', spy:0, distance:33.73, planets:1, faction:'moviton', resource1:'meteorite', resource2:'hydrogen',  stats:{ 'power':2835, 'defense':3390, 'speed':8  }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:337300 }], notifs:['interstellarMovitonPane'], }
            state.data['star21601'] =  { id:'star21601',  unlocked:false, status:'new', spy:0, distance:33.86, planets:2, faction:'moviton', resource1:'oil',       resource2:'hydrogen',  stats:{ 'power':2901, 'defense':2952, 'speed':14 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:338600 }], notifs:['interstellarMovitonPane'], }
            state.data['star63801'] =  { id:'star63801',  unlocked:false, status:'new', spy:0, distance:34.2,  planets:5, faction:'moviton', resource1:'ice',       resource2:'oil',       stats:{ 'power':2548, 'defense':2405, 'speed':15 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:342000 }], notifs:['interstellarMovitonPane'], }
            state.data['star187202'] = { id:'star187202', unlocked:false, status:'new', spy:0, distance:34.35, planets:5, faction:'moviton', resource1:'silicon',   resource2:'gem',       stats:{ 'power':4233, 'defense':2482, 'speed':15 }, costType:'FIXED', baseCosts:[{ id:'antimatter', count:343500 }], notifs:['interstellarMovitonPane'], }
            /*----------------------------------------------------------------*/
            
            // DARKMATTER
            /*----------------------------------------------------------------*/
            state.data['darkmatter'] = { id:'darkmatter', unlocked:false, count:0, notifs:['darkmatterPane'], }
            /*----------------------------------------------------------------*/
            
            // DM CARNELIAN
            /*----------------------------------------------------------------*/
            state.data['upgradeGain'] =        { id:'upgradeGain',     unlocked:false, count:0, max:1, costType:'FIXED', baseCosts:[{ id:'darkmatter', count:5  }], notifs:['stargazeCarnelianPane'], }
            state.data['upgradeStorage1'] =    { id:'upgradeStorage1', unlocked:false, count:0, max:1, costType:'FIXED', baseCosts:[{ id:'darkmatter', count:8  }], notifs:['stargazeCarnelianPane'], }
            state.data['upgradeStorage2'] =    { id:'upgradeStorage2', unlocked:false, count:0, max:1, costType:'FIXED', baseCosts:[{ id:'darkmatter', count:21 }], notifs:['stargazeCarnelianPane'], }
            state.data['techEnergyStorage6'] = { id:'energyStorageL6', unlocked:false, count:0, max:1, costType:'FIXED', baseCosts:[{ id:'darkmatter', count:26 }], notifs:['stargazeCarnelianPane'], unlocks:['energyS6'], }
            state.data['upgradeStorage3'] =    { id:'upgradeStorage3', unlocked:false, count:0, max:1, costType:'FIXED', baseCosts:[{ id:'darkmatter', count:37 }], notifs:['stargazeCarnelianPane'], }
            /*----------------------------------------------------------------*/
            
            // DM PRASNIAN
            /*----------------------------------------------------------------*/
            state.data['techPlasma3'] =        { id:'techPlasma3',        unlocked:false, count:0, max:1, costType:'FIXED', baseCosts:[{ id:'darkmatter', count:11 }], notifs:['stargazePrasnianPane'], unlocks:['plasmaT3', 'achPlasmaT3'], }
            state.data['upgradeWonder1'] =     { id:'upgradeWonder1',     unlocked:false, count:0, max:1, costType:'FIXED', baseCosts:[{ id:'darkmatter', count:13 }], notifs:['stargazePrasnianPane'], }
            state.data['upgradeWonder2'] =     { id:'upgradeWonder2',     unlocked:false, count:0, max:1, costType:'FIXED', baseCosts:[{ id:'darkmatter', count:16 }], notifs:['stargazePrasnianPane'], }
            state.data['upgradeWonder3'] =     { id:'upgradeWonder3',     unlocked:false, count:0, max:1, costType:'FIXED', baseCosts:[{ id:'darkmatter', count:19 }], notifs:['stargazePrasnianPane'], }
            state.data['techPlasma4'] =        { id:'techPlasma4',        unlocked:false, count:0, max:1, costType:'FIXED', baseCosts:[{ id:'darkmatter', count:25 }], notifs:['stargazePrasnianPane'], unlocks:['plasmaT4', 'achPlasmaT4'], }
            state.data['techPlasmaStorage3'] = { id:'techPlasmaStorage3', unlocked:false, count:0, max:1, costType:'FIXED', baseCosts:[{ id:'darkmatter', count:15 }], notifs:['stargazePrasnianPane'], unlocks:['plasmaS3'], }
            /*----------------------------------------------------------------*/
            
            // DM HYACINITE
            /*----------------------------------------------------------------*/
            state.data['upgradeScience1'] =    { id:'upgradeScience1',    unlocked:false, count:0, max:1, costType:'FIXED', baseCosts:[{ id:'darkmatter', count:7  }], notifs:['stargazeHyacinitePane'], }
            state.data['upgradeScience2'] =    { id:'upgradeScience2',    unlocked:false, count:0, max:1, costType:'FIXED', baseCosts:[{ id:'darkmatter', count:16 }], notifs:['stargazeHyacinitePane'], }
            state.data['techScience5'] =       { id:'techScience5',       unlocked:false, count:0, max:1, costType:'FIXED', baseCosts:[{ id:'darkmatter', count:24 }], notifs:['stargazeHyacinitePane'], unlocks:['scienceT5', 'achScienceT5'], }
            state.data['upgradeEnergyBoost'] = { id:'upgradeEnergyBoost', unlocked:false, count:0, max:1, costType:'FIXED', baseCosts:[{ id:'darkmatter', count:36 }], notifs:['stargazeHyacinitePane'], }
            /*----------------------------------------------------------------*/
            
            // DM KITRINOS
            /*----------------------------------------------------------------*/
            state.data['upgradeTier1'] =       { id:'upgradeTier1',       unlocked:false, count:0, max:1, costType:'FIXED', baseCosts:[{ id:'darkmatter', count:8  }], notifs:['stargazeKitrinosPane'], }
            state.data['techEnergyStorage5'] = { id:'techEnergyStorage5', unlocked:false, count:0, max:1, costType:'FIXED', baseCosts:[{ id:'darkmatter', count:14 }], notifs:['stargazeKitrinosPane'], unlocks:['energyS5'], }
            state.data['boostCapital'] =       { id:'boostCapital',       unlocked:false, count:0, max:1, costType:'FIXED', baseCosts:[{ id:'darkmatter', count:30 }], notifs:['stargazeKitrinosPane'], }
            state.data['techTier5'] =          { id:'techTier5',          unlocked:false, count:0, max:1, costType:'FIXED', baseCosts:[{ id:'darkmatter', count:35 }], notifs:['stargazeKitrinosPane'], unlocks:['carbonT5', 'achCarbonT5', 'oilT5', 'achOilT5', 'metalT5', 'achMetalT5', 'gemT5', 'achGemT5', 'woodT5', 'achWoodT5', 'siliconT5', 'achSiliconT5', 'uraniumT5', 'achUraniumT5', 'lavaT5', 'achLavaT5', 'lunariteT5', 'achLunariteT5', 'methaneT5', 'achMethaneT5', 'titaniumT5', 'achTitaniumT5', 'goldT5', 'achGoldT5', 'silverT5', 'achSilverT5', 'hydrogenT5', 'achHydrogenT5', 'heliumT5', 'achHeliumT5', 'iceT5', 'achIceT5'], }
            /*----------------------------------------------------------------*/
            
            // DM MOVITON
            /*----------------------------------------------------------------*/
            state.data['upgradeFuel1'] =     { id:'upgradeFuel1',     unlocked:false, count:0, max:1, costType:'FIXED', baseCosts:[{ id:'darkmatter', count:11 }], notifs:['stargazeMovitonPane'], }
            state.data['upgradeSpaceship'] = { id:'upgradeSpaceship', unlocked:false, count:0, max:1, costType:'FIXED', baseCosts:[{ id:'darkmatter', count:23 }], notifs:['stargazeMovitonPane'], }
            state.data['techMeteorite3'] =   { id:'techMeteorite3',   unlocked:false, count:0, max:1, costType:'FIXED', baseCosts:[{ id:'darkmatter', count:37 }], notifs:['stargazeMovitonPane'], unlocks:['meteoriteT3', 'achMeteoriteT3'], }
            state.data['techMeteorite4'] =   { id:'techMeteorite4',   unlocked:false, count:0, max:1, costType:'FIXED', baseCosts:[{ id:'darkmatter', count:49 }], notifs:['stargazeMovitonPane'], unlocks:['meteoriteT4', 'achMeteoriteT4'], }
            /*----------------------------------------------------------------*/
            
            // DM OVERLORD
            /*----------------------------------------------------------------*/
            state.data['boostDarkmatter'] = { id:'boostDarkmatter', unlocked:false, count:0, max:1, costType:'FIXED', baseCosts:[{ id:'darkmatter', count:30 }], notifs:['stargazeOverlordPane'], }
            state.data['techNanoswarm0'] =  { id:'techNanoswarm0',  unlocked:false, count:0, max:1, costType:'FIXED', baseCosts:[{ id:'darkmatter', count:32 }], notifs:['stargazeOverlordPane'], unlocks:['techNanoswarm1'], }
            state.data['upgradeFaction'] =  { id:'upgradeFaction',  unlocked:false, count:0, max:1, costType:'FIXED', baseCosts:[{ id:'darkmatter', count:49 }], notifs:['stargazeOverlordPane'], }
            /*----------------------------------------------------------------*/
        ...
        computeProdValues({ state, commit }) {
                ...
                if (canProduce) {
                    ...
                    if ('outputs' in item) {
                        item.outputs.forEach(output => {
                            temp[output.id].prod += output.count * item.active
                        })
                    }
                }
            })
            ...
            state.resources.forEach(item => {
                temp[item.id].boost = 1.0 + boost
                if (item.id == 'science' && state.data['boostScience'].unlocked && state.data['boostScience'].count > 0) temp[item.id].boost += 0.02 * state.data['boostScience'].count
            })
        ...
        onBuild({ state, commit, dispatch }, id) {
            ...
            /*----------------------------------------------------------------*/
                ...
                for (let i = 0; i < state.resources.length; i++) {
                    let item = state.resources[i]
                    if ('baseStorage' in item && item.baseStorage == 50 && item.storage < 6400) item.storage = 6400
                }
            }
            /*----------------------------------------------------------------*/
            ...
            /*----------------------------------------------------------------*/
                ...
                if (item.count < 20) item.count = 20
            }
            /*----------------------------------------------------------------*/
        ...
        /*--------------------------------------------------------------------*/
        build({ state, dispatch, commit }, id, count) {
        ...
        /*--------------------------------------------------------------------*/
        setActiveShip({ state, commit }, id, count) {
        ...
        /*--------------------------------------------------------------------*/
        exploreStar({ state }, id) {
        
            if (state.data['spaceship'].count > 0) {
            
                let star = state.data[id]
                let exploreCost = star.distance * 10000
                let antimatter = state.data['antimatter']
                if (antimatter.count >= exploreCost) {
                    antimatter.count -= exploreCost
                    star.state = 'discovered'
                }
            }
        },
        /*--------------------------------------------------------------------*/
        spyStar({ state, commit, getters }, id) {
        
            let star = state.data[id]

            let chance = getters.getSpyChance(star) / 100
            let roll = Math.random()
            if (chance >= roll) star.spy += 1
            else {
        ...
        /*--------------------------------------------------------------------*/
        invadeStar({ state, getters, dispatch, commit }, id) {
        
            let activeFleet = state.activeFleet
            if (activeFleet.stats.power != 0) {
                let star = state.data[id]
                
                let chance = getters.getInvadeChance(star)
                if (chance == 'peace') {
                    dispatch('absorbStar', id)
                    return
                }
        ...
        rebirth({ state, getters, dispatch }) {
            ...
            if (state.data['dysonT3'].count < 1) return
            
            state.data['darkmatter'] += getters.getPotentialDM
            ...
            for (let i in state.data) {
                ...
                if (!(item.id in exludedList)) {
                    ...
                    if ('status' in item) item.state = 'new'
